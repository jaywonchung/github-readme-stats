...
const renderRepoCard = (repo, options = {}) => {
  ...
  const card = new Card({
    ...
    titlePrefixIcon: false, //icons.contribs,
    width: 400,
    height,
    border_radius,
    colors,
  ...
  card.setCSS(`
    .description { font: 400 12px '-apple-system', 'Segoe UI', Ubuntu, Sans-Serif; fill: ${colors.textColor} }
    .gray { font: 400 12px '-apple-system', 'Segoe UI', Ubuntu, Sans-Serif; fill: ${colors.textColor} }
    .icon { fill: ${colors.iconColor} }
    .badge { font: 600 12px '-apple-system', 'Segoe UI', Ubuntu, Sans-Serif; }
