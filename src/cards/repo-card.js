...
const renderRepoCard = (repo, options = {}) => {
  ...
  card.setCSS(`
    .description { font: 400 12px Roboto, 'Segoe UI', Ubuntu, Sans-Serif; fill: ${colors.textColor} }
    .gray { font: 400 12px Roboto, 'Segoe UI', Ubuntu, Sans-Serif; fill: ${colors.textColor} }
    .icon { fill: ${colors.iconColor} }
    .badge { font: 600 12px Roboto, 'Segoe UI', Ubuntu, Sans-Serif; }
